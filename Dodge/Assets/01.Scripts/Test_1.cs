...
public class Test_1 : MonoBehaviour
{
    ...
    private void Start()
    {
        // int 1 = 0은 반복을 시작하는 숫자, i < 10은 i 가 10보다 작을 떄까지 반복, i++는 i를 1씩 증가
        /*for (int i = 0; i < 10; i++)
        {
            Debug.Log(i);
        }*/
    ...
    private void Update()
    {
        ...
        //while문은 괄호안에 있는 값이 만족을 할 때까지만 반복한다.
       /* while (test_bool1 < 10)
        {
    ...
    //비슷한기능(Ctal + k 누른 후 Ctrl + C) -> 이걸 풀려면 (Ctal + k 누른 후 Ctrl + U)
